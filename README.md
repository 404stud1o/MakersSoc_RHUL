...
<b>To commit and push for any change</b>

1. Sign into GitHub with Makers' email in VS Code, the password is saved in Google Password Manager
2. Clone and connect to `404stud1o/MakersSoc_RHUL` repository
3. Commit and push once you have finish making changes or adding content
